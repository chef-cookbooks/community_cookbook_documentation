...
If you're interested in contributing to community cookbooks or just have a question about one of our cookbooks we'd love to chat. You can find us in #cookbook-design on the [Chef Community Slack](https://community-slack.chef.io/).
...
All of our cookbooks can be found in our [GitHub organization](https://github.com/chef-cookbooks/). All cookbooks include GitHub issue templates to help gather information needed for a thorough review.
...
2. **Green CI Tests:** We use [GitHub Actions](https://github.com/features/actions) and [Travis CI](https://travis-ci.org/) CI systems to test all pull requests. We require these test runs to succeed on every pull request before being merged.
